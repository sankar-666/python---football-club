...
insert  into `coach`(`coach_id`,`login_id`,`club_id`,`fname`,`lname`,`place`,`phone`,`email`,`photo`,`dob`) values (1,1,1,'dsa','dsad','sda',NULL,'das','asd','das');
...
insert  into `message`(`message_id`,`sender_id`,`receiver_id`,`message`,`date`) values (1,10,1,'hello','2023-03-12'),(2,10,3,'hi','2023-03-12'),(3,10,20,'off','2023-03-12');
...
insert  into `noc_request`(`noc_id`,`sender_id`,`club_id`,`date`) values (1,10,1,'2023-03-12');
...
insert  into `nutretion`(`nutretion_id`,`login_id`,`club_id`,`fname`,`lname`,`place`,`phone`,`email`,`photo`,`dob`) values (1,3,1,'san','kar','kochi','6238526459','safasfssfd@gmail.com',NULL,NULL);
...
insert  into `player`(`player_id`,`login_id`,`club_id`,`fname`,`lname`,`place`,`phone`,`email`,`ref_id`,`status`,`aadhar_no`,`photo`,`dob`) values (1,10,1,'san','kar','alpy','678687','dasj',NULL,NULL,NULL,NULL,NULL);
...
insert  into `practice`(`practice_id`,`coach_id`,`practice`,`place`,`date`,`time`) values (1,1,'ground','alpy','3454','22');
...
insert  into `psysician`(`psysician_id`,`login_id`,`club_id`,`psysician`,`place`,`phone`,`email`,`photo`,`dob`) values (1,20,1,'suni','kottayam','78979','nbashjndsjh',NULL,NULL);
...
insert  into `video`(`video_id`,`video`,`title`) values (1,'static/uploads/87d0445c-d78a-44d1-a330-cca455915fc6WhatsApp Video 2022-11-14 at 11.09.34 AM.mp4','sample');
